...
?>
    <form action="congthanhtoan.php" method="post" style="text-align: center;">
    <input type="hidden" name="total_congthanhtoan" value="<?php echo $subtotal ?>">
    <button class="btn btn-success payment_href" name="redirect" id="redirect" style="font-size: 17px;">
        Thanh toán VNPAY
    </button>
</form><br><br><br><br>
 <?php
