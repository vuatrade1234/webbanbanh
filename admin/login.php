...
<?php
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if (!preg_match($pattern, $password)) {
			$login_check = "<p style='color:rgb(54, 51, 218);'>Mật khẩu phải có ít nhất 8 ký tự, bao gồm chữ hoa, chữ thường, số và ký tự đặc biệt.</p>";
		} else {
...
<div class="form-tt">
	<section id="content">
		<form action="login.php" method="post" name="dang-ky">
			<h2>Đăng nhập</h2>
			...
			<a href="forgotpass.php" style="color:rgb(28, 102, 37);" class="psw-text">Quên mật khẩu</a>
